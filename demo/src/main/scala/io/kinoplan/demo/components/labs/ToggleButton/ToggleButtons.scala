...
object ToggleButtons extends ScalaCssReactImplicits {
  ...
  case class State(alignment: String = "left", formats: Array[String] = Array("bold", "italic")) {
    ...
    def handleFormat(value: String) =
      if (formats.contains(value)) copy(formats = formats.filterNot(_ == value))
              ...
              div(
                ...
                MuiToggleButtonGroup(exclusive = true, onChange = handleAlignment)(
                  ...
                  MuiToggleButton()(
                    value := "justify",
                    disabled := true,
                    MuiIcons(MuiIconsModule.FormatAlignJustify)()
                  )
                )
              ),
            ...
            MuiGrid(item = true, xs = 12, sm = 6)(
              div(
                ...
                MuiToggleButtonGroup(exclusive = true, onChange = handleFormat)(
                  ...
                  MuiToggleButton()(
                    value := "underlined",
                    MuiIcons(MuiIconsModule.FormatUnderlined)()
                  ),
                  MuiToggleButton()(
                    value := "color",
                    disabled := true,
