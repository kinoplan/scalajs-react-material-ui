    ...
    def render(props: Props): VdomElement = {
      ...
      div(
        ComponentContainer("Outlined Buttons")(
          div(
            MuiButton(variant = MuiButton.Variant.outlined)(css.marginButton, "Default"),
            MuiButton(
            ...
            MuiButton(variant = MuiButton.Variant.outlined)(css.marginButton, disabled := true, "Disabled"),
            MuiButton(variant = MuiButton.Variant.outlined)(css.marginButton, href := "#outlined-buttons", "Link"),
            input.file(
              css.inputButton,
              accept := "image/*",
