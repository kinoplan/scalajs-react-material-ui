  ...
  class Backend(t: BackendScope[Props, Unit]) {
    ...
    def render(props: Props): VdomElement = {
      ...
      val tabLabel = VdomNode(
        MuiBadge(badgeContent = VdomNode(4), color = MuiBadge.Color.secondary)(css.badgePadding, "Item One").rawNode
      )
        ...
        ComponentContainer("Simple Badges")(
          div(
            div(
              ...
              MuiBadge(badgeContent = VdomNode(10), color = MuiBadge.Color.secondary)(
                css.badgeMargin,
                MuiIcons(MuiIconsModule.Mail)()
              ),
              MuiIconButton()(
            ...
            MuiBadge(badgeContent = VdomNode(4), color = MuiBadge.Color.primary)(
              css.badgeMargin,
              MuiTypography()(css.badgePadding, "Typography")
            ),
            MuiBadge(badgeContent = VdomNode(4), color = MuiBadge.Color.primary)(
              css.badgeMargin,
