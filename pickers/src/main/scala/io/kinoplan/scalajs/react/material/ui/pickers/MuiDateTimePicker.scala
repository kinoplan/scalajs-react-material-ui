...
object MuiDateTimePicker extends ReactBridgeComponent with JsWriterImplicits with MuiDateTimePickerExtensions {
  override protected lazy val componentValue: js.Object = RawComponent

  @JSImport("material-ui-pickers/DateTimePicker/DateTimePicker.js", JSImport.Default)
  @js.native
...
trait MuiDateTimePickerExtensions {
