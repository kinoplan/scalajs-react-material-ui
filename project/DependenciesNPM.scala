object DependenciesNPM {
  ...
  val materialUiCore                = "@mui/material"                      -> "5.8.1"
  val materialUiIcons               = "@mui/icons-material"                -> "5.8.0"
  val materialUiLab                 = "@mui/lab"                           -> "5.0.0-alpha.83"
  ...
  val typesReact                    = "@types/react"                       -> "17.0.45"
  val typesReactDom                 = "@types/react-dom"                   -> "17.0.17"
